      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-8">
        ...
        <div className="hidden w-full md:block md:w-auto">
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 md:flex-row md:space-x-16 md:mt-0">
            <li>
              <Link to="/" className="nav-link block py-2 px-3 md:p-0">
                Inicio
              </Link>
            </li>
            <li>
              <Link to="/productos" className="nav-link block py-2 px-3 md:p-0">
                Productos
              </Link>
            </li>
            <li>
              <Link to="/contacto" className="nav-link block py-2 px-3 md:p-0">
                Contacto
              </Link>
            </li>
          </ul>
